...
export const PROJECT_SHOWCASE: ProjectShowcaseListItem[] = [
  ...
  },
  {
    ...
    href: "/projects",
    tags: ["Reactjs", "Vite", "Tailwindcss", "Vercel", "MUI", "React Router Dom", "NodeJs", "ExpressJs", "MOngo DB"],
    image: {
...
export const PROJECTS_CARD: ProjectCardProps[] = [
  ...
  },
  {
    ...
    sourceCodeHref: "https://github.com/AhsanAlijs/Astral_Managment-System-React-Firebase",
    liveWebsiteHref: "https://astraldevelopersmanagement.web.app/",
  },
  {
    name: "Filimo School",
    favicon: "https://yt3.googleusercontent.com/vHTKesLbMXwTzfUP5sW2Shd10vtONmrzZIGvdG2FQnl91b_49gMUi4gFWUIVT_Zyhg4PlPvYaw=s900-c-k-c0x00ffffff-no-rj",
    imageUrl: [
  ...
  {
    name: "D S R",
    favicon: "https://dsr-production.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FlogoD.dbded834.png&w=256&q=75",
    imageUrl: [
      "https://i.ibb.co/n3cT8LF/dsr-production-vercel-app.png",
      "https://i.ibb.co/Y7rCXZ7/dsr-production-vercel-app-dashboard.png",
    ],
    description:
      `Elevate your recruiting game with a custom player profile
  ...
  },
  {
    ...
    favicon: "https://raw.githubusercontent.com/AhsanAlijs/Chating-App-ReactJS-DashBoard/refs/heads/main/asset/logo.png?token=GHSAT0AAAAAACYNA4MEYHHIJARYTZHDGYWAZYBBPSA",
    imageUrl: [
    ...
    sourceCodeHref: "https://github.com/AhsanAlijs/Chating-App-ReactJS-DashBoard",
